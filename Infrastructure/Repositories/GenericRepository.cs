...
namespace Infrastructure.Repositories
{
    public class GenericRepository<T> : IGenericRepository<T> where T : BaseEntity
    {
        ...
        public async Task<IReadOnlyList<T>> GetAllyWithSpecificationsAsync(ISpecifications<T> specifications)
        ...
        private IQueryable<T> ApplySpecifications(ISpecifications<T> specifications)
            =>  SpecificationEvaluater<T>.GetQuery(_context.Set<T>().AsQueryable(), specifications);
